...
describe('UpdateDiscordSetting Handler', () => {
  it('should update a discord setting successfully', async () => {
    ...
    // Mock server lookup, setting validation, and update success
    ...
    mockDb.run.mockResolvedValueOnce({ success: true }) // Update succeeds
    ...
    expect(mockDb.bind).toHaveBeenCalledWith(updateData.setting_value, 'system', 'srv_internal_123', updateData.setting_key);
  });
