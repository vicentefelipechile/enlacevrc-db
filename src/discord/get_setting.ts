/**
 * @file        discord/get_setting.ts
 * @author      vicentefelipechile
 * @description This function retrieves a Discord setting by its Discord server ID and optional setting key from the database.
 */
 ...
 */
export async function GetSetting(request: Request, env: Env, discordServerId: string): Promise<Response> {
    try {
        // Data extraction
        ...
        if (!settingKey) return ErrorResponse('Missing required parameter: setting_key', 400);
